...
ТАКЖЕ СТРОГО ИГНОРИРУЙ новости про ремонт, реконструкцию, реставрацию или реструктуризацию (например, ремонт терминала аэропорта, реконструкция больницы/школы, модернизация сетей), так как обычно это не подразумевает найм новых сотрудников в долгосрочной перспективе в компанию-клиента. В таких случаях СРАЗУ отвечай «Нет предложений».
